...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answers: ["(The basic) rights of Americans", "State governments", "The President", "Foreign nations"],
  ...
  },
  {
    ...
    correctAnswers: ["Visit uscis.gov/citizenship/testupdates for the current Speaker"],
  ...
  },
  {
    ...
    answers: ["(Because of) the 22nd Amendment", "Because of age limits", "Congress decided", "The Constitution originally said so"],
  ...
  },
  {
    ...
    correctAnswers: ["Visit uscis.gov/citizenship/testupdates for the current President"],
  ...
  },
  {
    ...
    correctAnswers: ["Visit uscis.gov/citizenship/testupdates for the current Vice President"],
  ...
  },
  {
    ...
    answers: ["Reviews laws", "Explains laws", "Resolves disputes about the law", "Makes laws"],
  ...
  },
  {
    ...
    correctAnswers: ["Visit uscis.gov/citizenship/testupdates for the current Chief Justice"],
  ...
  },
  {
    ...
    answers: ["Powers not given to federal government belong to states or people", "It protects free speech", "It gives voting rights", "It creates the Supreme Court"],
  ...
  // =====================================================
  {
    ...
    answers: ["Citizens eighteen (18) and older can vote", "Only men can vote", "Only property owners can vote", "Only educated people can vote"],
  ...
  },
  {
    ...
    answers: ["Give up loyalty to other countries and defend the Constitution", "Pay taxes and vote", "Join military and work", "Learn English and history"],
  ...
  },
  {
    ...
    answers: ["(Battle of) Bunker Hill", "Declaration of Independence", "Washington Crossing the Delaware", "Pearl Harbor"],
  ...
  },
  {
    ...
    answers: ["They helped people understand the Constitution", "They declared independence", "They freed slaves", "They started the war"],
  ...
  },
  {
    ...
    answers: ["Founded the first free public libraries", "First Postmaster General", "Helped write the Declaration of Independence", "Was the first President"],
  ...
  },
  {
    ...
    answers: ["Writer of the Declaration of Independence", "Third president", "First president", "Civil War general"],
  ...
  },
  {
    ...
    answers: ["\"Father of the Constitution\"", "Fourth president", "First president", "Civil War general"],
  ...
  },
  {
    ...
    answers: ["Freed the slaves", "Saved the Union", "Led during the Civil War", "First president"],
  ...
  },
  {
    ...
    answers: ["After the Civil War", "During Reconstruction", "(With the) 15th Amendment", "1776"],
  ...
  },
  {
    ...
    answers: ["Because Germany attacked U.S. ships", "To support the Allied Powers", "Pearl Harbor", "To stop communism"],
  ...
  },
  {
    ...
    answers: ["General during World War II", "President during Korean War", "34th president", "Writer of Declaration"],
  ...
  },
  {
    ...
    answers: ["A holiday to honor people in the military", "A holiday to honor people who have served", "Independence Day", "Memorial Day"],
